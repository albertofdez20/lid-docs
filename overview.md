...
Today these primitives are consumed through the Lid web app and the MCP write-surface v1, where agents run the same loop a person does. The roadmap exposes them as a full public API for developers and AI agents to integrate directly.
...
- **Developer surface (roadmap):** Full public Agentic Commerce API plus SDK
...
- **Full public Agentic Commerce API.** REST and SDK surface for developers and AI agents to create products, generate affiliate links, and route transactions programmatically at scale.
