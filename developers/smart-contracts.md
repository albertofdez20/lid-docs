...
This page describes the architecture at a conceptual level. Full ABIs, method signatures, and example code will publish when the contracts are audited and the public API stabilizes.
...
The current contracts are designed for controlled upgradability during the alpha phase. Upgrade authority will be governed by a multi-sig and eventually transitioned to a decentralized governance model as the protocol matures.
