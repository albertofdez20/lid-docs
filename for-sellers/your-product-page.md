...
- Trust signals: instant payout, Solana settlement, 3% infrastructure fee

## The affiliate side of the page

If you enabled affiliate commission, the page has a second surface. Any visitor can click **Earn on this product** and generate their personal share link in one step.

They don't need your permission. They don't sign a contract. They accept the commission you already set, and the smart contract does the rest when their link produces a sale.

This is the thing that's different. The product page isn't just a place to buy. It's a place to enroll as a distributor.
...
- Custom branding (your own logo, colors, layout)
...
The product page is also the front door for attribution, trust, and conversion. Three things matter more than everything else.

1. **Clarity in the first scroll.** What, who, outcome.
