...
A $100 sale with a 20% affiliate commission, driven by an affiliate link:
...
A Pro tier is planned for when the product earns the right to charge for it. Expected structure:

| Tier | Transaction fee | Monthly | Includes |
|---|---|---|---|
| **Free** | 5% | $0 | Full core loop. |
