...
**Sellers.** Creating digital products and opening them up to distribution. Start with [What is LID](getting-started/what-is-lid.md), then [Create a product](for-sellers/create-a-product.md).

**Affiliates.** Sharing links and earning on every sale. Read [How the affiliate system works](for-affiliates/how-affiliate-works.md).

**Developers and agent builders.** Integrating LID as the economic layer for autonomous software. Start at [Developers overview](developers/overview.md).

**Investors and partners.** Read the [Vision](company/vision.md) and [Roadmap](company/roadmap.md).
